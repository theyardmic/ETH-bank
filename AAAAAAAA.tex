...
\usepackage{amsmath}
\usepackage{array}
\usepackage[executivepaper, margin=0.4in]{geometry}
\usepackage{graphicx} 
...
\vspace{290pt}
\begin{center}
    \includegraphics[width=\textwidth]{Q1.PNG} % Adjust the width as needed
\end{center}
\newpage
...
\newpage
\begin{center}
    \includegraphics[width=\textwidth]{Q2.PNG} % Adjust the width as needed
